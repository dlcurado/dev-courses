...
{
    private UpdateCategoryTestFixture _fixture;
    ...
    [MemberData(
        nameof(UpdateCategoryTestDataGenerator.GetCategoryToUpdate),
        parameters: 10,
        MemberType = typeof(UpdateCategoryTestDataGenerator)
    )]
    public async Task UpdateCategory(Entity.Category exampleCategory, UpdateCategoryInput exampleInput)
    {
        ...
        var output = await useCase.Handle(exampleInput, CancellationToken.None);
    ...
    [Theory(DisplayName = nameof(UpdateCategoryWithouProvidingIsActive))]
    [Trait("Application", "UpdateCategory - Use Cases")]
    [MemberData(
        nameof(UpdateCategoryTestDataGenerator.GetCategoryToUpdate),
        parameters: 10,
    ...
    public async Task UpdateCategoryWithouProvidingIsActive(Entity.Category exampleCategory, UpdateCategoryInput exampleInput)
    {
